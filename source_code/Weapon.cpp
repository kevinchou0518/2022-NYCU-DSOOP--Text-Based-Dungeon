...
Weapon::Weapon(string name, int hth, int atk, int def) :Equipment(name, hth, atk, def,'w') {}

Weapon::Weapon(string name, int hth, int atk, int def,int cost) : Equipment(name, hth, atk, def, 'w',cost)
{
}
...
bool Weapon::triggerBackpack(Object* player)
{
	Player* maincharacter = dynamic_cast<Player*>(player);
	maincharacter->getBackpack()->addweapon(this);
